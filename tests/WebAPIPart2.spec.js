// Login through UI ---> collect all the storage components and store it in a flie named .json
...
test('Client App Login', async()=>
{
    ...
    await expect(page.locator(".user__name [type='text']").first()).toHaveText("mishraankita0794@gmail.com");
